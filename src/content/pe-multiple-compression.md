---
title: "Why a Company's Profit Can Rise While Its Stock Price Falls"
description: "A stock price can fall even as earnings grow when the market lowers the multiple it's willing to pay for those earnings, a process called P/E multiple compression."
excerpt: "Multiple compression happens when a stock's price-to-earnings ratio shrinks even as the company's earnings grow, so the price falls or stalls despite improving results. Rising interest rates, cooling growth expectations, and sector-wide re-rating are the three most common causes."
keywords:
  - PE multiple compression
  - price to earnings ratio
  - earnings growth stock price fall
  - valuation multiple
  - interest rates stock valuation
  - growth expectations
  - stock re-rating
  - forward PE
...
keyTakeaways:
  ...
  - "A stock's price is approximately <strong>earnings × the P/E multiple</strong>, so price can fall if the multiple shrinks by more than earnings grow, even when earnings growth is positive."
  - "In 2022, S&P 500 earnings grew roughly <data value=\"9.4\">9.4%</data> and <data value=\"5.8\">5.8%</data> year-over-year in Q1 and Q2, yet the index's forward P/E compressed from around <data value=\"21\">21</data> at the start of the year to roughly <data value=\"18.2\">18.2</data> by late July as the Federal Reserve raised interest rates — the S&P 500 itself finished 2022 down about 19%."
  - "Rising interest rates are the most common cause of broad multiple compression, because higher rates make future earnings worth less in today's dollars and make safer alternatives like bonds more competitive with stocks."
  - "Guidance and forward expectations, not the reported quarter, usually explain a 'beat but the stock fell' headline — the market prices in expectations before the earnings report, so the report is judged against those expectations, not against the prior year."
  - "Cluenex displays discounted cash flow and owner earnings estimates alongside a stock's current price, letting you separate whether a price move reflects the business changing or the market's willingness to pay for it changing."
layout: base.njk
permalink: /learn/fundamental-analysis/pe-multiple-compression/
---
...
<dfn id="multiple-compression-def"><strong>P/E multiple compression</strong></dfn> is a decline in a stock's price-to-earnings ratio that occurs independently of the company's earnings, causing the share price to fall or stagnate even when reported profits rise.
</p>
<div class="def-source">Source: Standard valuation methodology; price = earnings per share × P/E multiple.</div>
</div>
...
If earnings rise <data value="20">20%</data> but the market decides the stock deserves a lower multiple — say, from <data value="20">20</data>x down to <data value="15">15</data>x — the share price can still fall. The company improved. What the market was willing to pay for that improvement did not keep pace.
...
The clearest recent example happened across the entire S&P 500, not just one company. S&P 500 companies grew earnings by roughly <data value="9.4">9.4%</data> year-over-year in Q1 2022 and <data value="5.8">5.8%</data> in Q2 2022 — real, positive profit growth. Over the same period, the Federal Reserve raised its benchmark interest rate aggressively to fight inflation that had reached multi-decade highs.

<div class="tbl-wrap">
<table class="dtbl">
<thead>
<tr><th>Measure</th><th>Early 2022</th><th>Late July 2022</th></tr>
</thead>
<tbody>
<tr><td>S&P 500 forward P/E</td><td>~21x</td><td>18.2x</td></tr>
<tr><td>S&P 500 trailing (LTM) P/E</td><td>~23x</td><td>20.2x</td></tr>
<tr><td>Q1/Q2 2022 earnings growth (YoY)</td><td>9.4% / 5.8%</td><td>—</td></tr>
</tbody>
</table>
</div>

The forward multiple compressed from roughly 21x to 18.2x in a matter of months while earnings kept growing. The S&P 500 finished 2022 down approximately <data value="19">19%</data> for the full year — a decline driven overwhelmingly by multiple compression rather than by an earnings collapse, since aggregate earnings were still higher than the year before. Individual companies that reported real profit growth in 2022 routinely saw their stocks fall for the same reason: the price they carried into the year assumed a lower-rate world that no longer existed.
...
- **What causes a P/E multiple to compress?**
...
- **Can a stock's price fall even when earnings grow?**
  Yes. Price is approximately earnings multiplied by the P/E multiple. If the multiple falls by a larger percentage than earnings rise, the price falls despite genuine earnings growth — this happened across the S&P 500 in 2022, when index earnings grew in the first half of the year while the forward P/E compressed from roughly 21x to 18.2x as the Federal Reserve raised rates.
...
- **What is the difference between an earnings miss and multiple compression?**
  An earnings miss means the company reported worse results than expected — a business-level event. Multiple compression means the market is paying less for the same or even improving earnings — a valuation-level event unrelated to that quarter's results. The two can happen together or independently.
...
- [P/E Ratio Explained: When is a Stock Expensive](/learn/technical-analysis/pe-ratio-valuation/) — the base metric multiple compression acts on
- [Forward P/E vs Trailing P/E](/learn/fundamental-analysis/forward-pe-vs-trailing-pe/) — which multiple to watch for compression signals
- [How Fed Interest Rate Decisions Affect Stock Prices](/learn/markets/fed-interest-rates-stock-prices/) — the primary driver of broad multiple compression
- [What is Revenue Guidance and Why Markets React So Strongly to It](/learn/fundamental-analysis/revenue-guidance/) — why "beat but fell" is usually a guidance story
- [Value Trap vs Bargain: How to Tell If a Cheap Stock Is Broken](/learn/fundamental-analysis/value-trap-vs-bargain/) — distinguishing a compressed multiple from a broken business
